...
func PrepareWorkflowScheduleData(schedule irminModels.WorkflowSchedule) (map[string]string, error) {
	...
	for index, trigger := range schedule.Triggers {
		...
		case *irminModels.WorkflowRunTrigger:
