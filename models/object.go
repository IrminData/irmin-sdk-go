...
type Object struct {
	...
	PhysicalAddress       string            `json:"physical_address,omitempty"        validate:"validurl"`      // The location of the object on the underlying object store. Formatted as a native URI with the object store type as scheme ("s3://...", "gs://...", etc.) Or, in the case of presign=true, will be an HTTP URL to be consumed via regular HTTP GET
